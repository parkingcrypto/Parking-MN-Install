...
COIN_TGZ='https://github.com/parkingcrypto/parking/releases/download/v1.1.0.1/parkingcore-1.1.0-linux.tar.gz'
SENTINEL_REPO='https://github.com/hexter2018/sentinel.git'
